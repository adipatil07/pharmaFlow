...
import 'package:pharma_supply/features/manufacturer/notifier/requested_medicine_notifier.dart';
import 'package:pharma_supply/services/firebase_service.dart';
import 'package:provider/provider.dart';
import 'package:pharma_supply/constants/app_theme.dart';

class RequestedMedicinePage extends StatelessWidget {
  final String medicineId;
  const RequestedMedicinePage({required this.medicineId, super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => RequestedMedicineNotifier(),
      child: Consumer<RequestedMedicineNotifier>(
                      ...
                      onPressed: provider.showLoadingOnButton
                          ...
                          : () async {
                              ...
                              await FirebaseService
                                  .updateRequestedMedicineDetails(medicineId, {
                                "status": "Approved",
  ...
  Widget buildDatePicker(BuildContext context, String label,
      ...
      required RequestedMedicineNotifier provider}) {
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 8.0),
      child: Row(
